    ...
    <MovieDetailsWrapper>
      ...
      <div className="modal">
        <div
          className="container"
          style={{
            backgroundImage: `url(https://sm.ign.com/t/ign_in/gallery/s/spider-man/spider-man-far-from-home-official-movie-posters_epch.1080.jpg)`,
        ...
        >
          ...
          <div className="infoMovie">
            ...
            <p className="overview">
              After a massive alien artifact lands on Earth, Niko Breckinridge
              leads an interstellar mission to track down its source and make
              first contact.
            </p>
          </div>
        </div>
